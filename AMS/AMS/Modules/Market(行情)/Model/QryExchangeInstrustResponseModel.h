//
//  AMSQryExchangeAllInstrustResponseModel.h
//  AMS
//
...
@class QryExchangeInstrustResponseModel;
@class QryExchangeInstrustMdata;
@class AMSDto;
@class AMSDtoList;
@class QryExchangeInstrustTimeDescription;

NS_ASSUME_NONNULL_BEGIN

#pragma mark - Object interfaces

@interface QryExchangeInstrustResponseModel : NSObject
@property (nonatomic, strong) QryExchangeInstrustMdata *mdata;
...
@interface QryExchangeInstrustMdata : NSObject
@property (nonatomic, copy) NSArray<AMSDto *> *dtos;
@end

@interface AMSDto : NSObject
@property (nonatomic, copy)   NSArray<AMSDtoList *> *dtoList;
@property (nonatomic, assign) NSInteger identifier;
@property (nonatomic, copy)   NSString *name;
@end

@interface AMSDtoList : NSObject
...
@property (nonatomic, copy)   NSArray<QryExchangeInstrustTimeDescription *> *timeDescriptions;
...
@interface QryExchangeInstrustTimeDescription : NSObject
