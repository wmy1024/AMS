...
- (void)p_setupViews {
    ...
    _topRightScroll.directionalLockEnabled = YES;
    ...
    _bottomRightScroll.showsVerticalScrollIndicator = NO;
    _bottomRightScroll.showsHorizontalScrollIndicator = NO;
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    }else if (scrollView == _topRightScroll){
        _bottomRightScroll.delegate = nil;
        _bottomRightScroll.contentOffset = CGPointMake(_topRightScroll.contentOffset.x, _bottomLeftScroll.contentOffset.y);
        _bottomRightScroll.delegate = self;
