...
@interface User_Onrtnerrorconditionalorder : NSObject
@property(nonatomic,strong) NSNumber *is_ErrorConditionalOrder_null;//ErrorConditionalOrder是否为null    1->是null;0->不是null;
