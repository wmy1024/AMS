...
@interface User_Onrspqryoptioninstrtradecost : NSObject
...
@property(nonatomic,copy) NSString *FixedMargin;//期权合约保证金不变部分
@property(nonatomic,copy) NSString *MiniMargin;//期权合约最小保证金
@property(nonatomic,copy) NSString *Royalty;//期权合约权利金
@property(nonatomic,copy) NSString *ExchFixedMargin;//交易所期权合约保证金不变部分
@property(nonatomic,copy) NSString *ExchMiniMargin;//交易所期权合约最小保证金
