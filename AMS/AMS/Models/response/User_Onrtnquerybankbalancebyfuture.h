...
@interface User_Onrtnquerybankbalancebyfuture : NSObject
@property(nonatomic,strong) NSNumber *is_NotifyQueryAccount_null;//NotifyQueryAccount是否为null    1->是null;0->不是null;
...
@property(nonatomic,copy) NSString *BankUseAmount;//银行可用金额
@property(nonatomic,copy) NSString *BankFetchAmount;//银行可取金额
