...
@interface User_Onerrrtnoptionselfcloseaction : NSObject
@property(nonatomic,strong) NSNumber *is_OptionSelfCloseAction_null;//OptionSelfCloseAction是否为null    1->是null;0->不是null;
