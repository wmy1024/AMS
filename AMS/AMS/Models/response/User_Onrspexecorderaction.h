...
@interface User_Onrspexecorderaction : NSObject
@property(nonatomic,strong) NSNumber *is_InputExecOrderAction_null;//InputExecOrderAction是否为null    1->是null;0->不是null;
