...
@interface User_Onrspparkedorderinsert : NSObject
@property(nonatomic,strong) NSNumber *is_ParkedOrder_null;//ParkedOrder是否为null    1->是null;0->不是null;
...
@property(nonatomic,copy) NSString *Status;//预埋单状态    '1'->未发送;'2'->已发送;'3'->已删除;
