...
@interface User_Onrspqryinstrumentordercommrate : NSObject
...
@property(nonatomic,copy) NSString *OrderCommByVolume;//报单手续费
@property(nonatomic,copy) NSString *OrderActionCommByVolume;//撤单手续费
