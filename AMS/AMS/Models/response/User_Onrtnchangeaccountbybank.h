...
@interface User_Onrtnchangeaccountbybank : NSObject
@property(nonatomic,strong) NSNumber *is_ChangeAccount_null;//ChangeAccount是否为null    1->是null;0->不是null;
...
@property(nonatomic,copy) NSString *NewBankAccount;//新银行帐号
@property(nonatomic,copy) NSString *NewBankPassWord;//新银行密码
