...
@interface User_Onerrrtnrepealfuturetobankbyfuturemanual : NSObject
@property(nonatomic,strong) NSNumber *is_ReqRepeal_null;//ReqRepeal是否为null    1->是null;0->不是null;
