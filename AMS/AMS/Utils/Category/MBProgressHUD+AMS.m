...
@implementation MBProgressHUD (AMS)

+ (MBProgressHUD*)createMBProgressHUDviewWithMessage:(NSString*)message isWindiw:(BOOL)isWindow
{
    UIView  *view = isWindow? (UIView*)[UIApplication sharedApplication].delegate.window:[AMSUtil getCurrentUIVC].view;
...
+ (void)hideHUD
{
    ...
    [self hideAllHUDsForView:[AMSUtil getCurrentUIVC].view animated:YES];
}
...
//        [[AMSUtil getCurrentUIVC].view addSubview:label];
//        
//        [UIView animateWithDuration:0.3 animations:^{
